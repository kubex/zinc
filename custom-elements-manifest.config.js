...
export default {
  ...
  // Exclude the internal subcomponents of the editor and flow-builder
  exclude: ['**/*.scss', '**/*.test.ts', 'src/components/editor/modules/**/*', 'src/components/flow-builder/modules/**/*'],
  plugins: [
    // Append package data
    {
