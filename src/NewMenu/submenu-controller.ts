...
import {MenuItem} from "@/NewMenu/menu-item";
...
export class SubmenuController implements ReactiveController
{
  ...
  constructor(host: ReactiveControllerHost & MenuItem, hasSlotController: HasSlotController)
  {
  ...
  private addListeners()
  {
    ...
    if(!this.isPopupConnected)
    {
      if(this.popupRef.value)
      {
        ...
        this.popupRef.value.addEventListener('zn-reposition', this.handlePopupReposition);
  ...
  private removeListeners()
  {
    ...
    if(this.isPopupConnected)
    {
      if(this.popupRef.value)
      {
        ...
        this.popupRef.value.removeEventListener('zn-reposition', this.handlePopupReposition);
  ...
  {
    if(this.hasSlotController.test('submenu') && !this.host.contains(e.relatedTarget as Node))
    {
      this.disableSubmenu();
    }
  };
  ...
  private handleSubmenuEntry(event: KeyboardEvent)
  {
    ...
    {
      menuItems = elt.querySelectorAll("zn-menu-item, [role^='menuitem']");
  ...
  private handlePopupReposition = () =>
  {
    ...
    this.host.style.setProperty('--safe-triangle-submenu-start-x', `${left}px`);
    this.host.style.setProperty('--safe-triangle-submenu-start-y', `${top}px`);
    this.host.style.setProperty('--safe-triangle-submenu-end-x', `${left}px`);
  ...
  private updateSkidding(): void
  {
    ...
    this.skidding = attrs.reduce((accumulator, attr) =>
    {
